...
public class Return {
    ...
    public static double circleArea(int radius) {
        // return 을 하게될경우 return 하게되는 값에 따라 void 자리를 수정진행
    ...
    public static void main(String[] args) {
        ...
        System.out.println("반지름이 5인 원의 넓이를 3으로 나눈 값 : " + area1 / 3);

        // 반지름이 5인 원의 넓이의 2배

        System.out.println("반지름이 5인 원의 넓이를 2배 값 : " + area1 * 2);

        // 함수끼리는 서로 호출하고 호출당하는 관계
        // 함수가 자신을 호출한 쪽으로 값을 전달하는 것이 출력(리턴값)
        // 함수의 결과값을 이용해 2차 작업을 하기 위해서는 함수의 전달값을 받아서 사용할 수 있어야 한다.
        // 함수의 전달값 return을 이용해 전달한다.
