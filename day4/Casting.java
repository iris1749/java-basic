...
public class Casting {
    public static void main(String[] args) {
        ...
        int a = 10; // 형변환 x
        double b = 10; // 형변환 o => int가 double로 바뀜 -> 자바가 바꿔줌(자동형 변환)

        int c = (int)3.14; // 형변환 x => double이 int로 바뀌여면 소수점을 때야됨. (수동형변환)
...
//        a2= new Dog();
        ...
        Cat c2 = (Cat)a2; // 자동형변환 x, a2에는 Cat과 Dog가 들어있을 수 있기 때문에 Cat이라고 확신할 수 없다.
